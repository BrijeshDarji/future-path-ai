    ...
    <LandingWrapper>
      ...
      <div className="inner-container">
        ...
        >
          ...
          <FormButton text={"Let's get started!"} />
        </motion.header>

        <div className="main-container">
          <div className="left-heading">
            <div className="title">
              <motion.div {...commonAnimation} transition={{ delay: 1.3 }}>
            ...
            <motion.p
              ...
              className="content"
            >
              Personalized career guidance for Post-10th and 12th grade students
              using AI/ML.
            </motion.p>
            <motion.div {...commonAnimation} transition={{ delay: 1.9 }}>
